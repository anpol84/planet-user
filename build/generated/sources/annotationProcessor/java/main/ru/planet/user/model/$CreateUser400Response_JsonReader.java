...
public final class $CreateUser400Response_JsonReader implements JsonReader<CreateUser400Response> {
  ...
  public $CreateUser400Response_JsonReader() {
  }
  ...
  @Override
  @Nullable
  public final CreateUser400Response read(JsonParser __parser) throws IOException {
    ...
    if (__parser.nextFieldName(__error_optimized_field_name)) {
      ...
      return new CreateUser400Response(_error);
    }
