...
public final class $CreateUser400Response_JsonWriter implements JsonWriter<CreateUser400Response> {
  private static final SerializedString __error_optimized_field_name = new SerializedString("error");

  public $CreateUser400Response_JsonWriter() {
  }

  @Override
  public final void write(JsonGenerator _gen, @Nullable CreateUser400Response _object) throws
      IOException {
    if (_object == null) {
      _gen.writeNull();
      return;
